...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MenuItem.enabled'
        db.add_column(u'menu_menuitem', 'enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Menu.enabled'
        db.add_column(u'menu_menu', 'enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MenuItem.enabled'
        db.delete_column(u'menu_menuitem', 'enabled')

        # Deleting field 'Menu.enabled'
        db.delete_column(u'menu_menu', 'enabled')
